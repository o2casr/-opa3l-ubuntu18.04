...
RUN apt-get update && \
    apt-get -y install libeigen3-dev libsdl2-dev libglew-dev curl && \
...
# ADTF packages
RUN wget https://artifactory.digitalwerk.net:443/artifactory/Product-Releases/ADTF/3.9.1/Linux/x86_64/gcc/5.4/ADTF-3.9.1.tgz && mkdir ADTF && tar -xzf ADTF-3.9.1.tgz -C ADTF 
RUN wget https://artifactory.digitalwerk.net:443/artifactory/Product-Releases/ADTF-Device-Toolbox/3.3.0/Linux/x86_64/gcc/5.4/ADTF-Device-Toolbox-3.3.0.tgz -P ADTF/addons/ && mkdir ADTF/addons/devicetoolbox && tar -xzf ADTF/addons/devicetoolbox*.tgz -C ADTF/addons/devicetoolbox/ --strip-components 1
RUN wget https://artifactory.digitalwerk.net:443/artifactory/Product-Releases/ADTF-Display-Toolbox/3.5.0/Linux/x86_64/gcc/5.4/ADTF-Display-Toolbox-3.5.0.tgz -P ADTF/addons/ && mkdir ADTF/addons/displaytoolbox && tar -xzf ADTF/addons/displaytoolbox*.tgz -C ADTF/addons/displaytoolbox/ --strip-components 1
RUN wget https://artifactory.digitalwerk.net:443/artifactory/dw-developer-sdk/dw/ddl/4.4.1/stable/0/package/71d4265f29f795a3fb34bf81a810f6280bd3737b/0/conan_package.tgz -P ADTF/3rdparty/ && mv ADTF/3rdparty/conan_package.tgz ADTF/3rdparty/ddl.tgz && mkdir ADTF/3rdparty/ddl && tar -xzf ADTF/3rdparty/ddl.tgz -C ADTF/3rdparty/ddl
