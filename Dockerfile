...
# ADTF packages
RUN wget -q https://artifactory.digitalwerk.net:443/artifactory/Product-Releases/ADTF/3.9.1/Linux/x86_64/gcc/5.4/ADTF-3.9.1.tgz && mkdir ADTF && tar -xzf ADTF-3.9.1.tgz -C ADTF 
RUN wget -q https://artifactory.digitalwerk.net:443/artifactory/Product-Releases/ADTF-Device-Toolbox/3.3.0/Linux/x86_64/gcc/5.4/ADTF-Device-Toolbox-3.3.0.tgz -P ADTF/addons/ && mkdir ADTF/addons/devicetoolbox && tar -xzf ADTF/addons/devicetoolbox*.tgz -C ADTF/addons/devicetoolbox/ --strip-components 1
RUN wget -q https://artifactory.digitalwerk.net:443/artifactory/Product-Releases/ADTF-Display-Toolbox/3.5.0/Linux/x86_64/gcc/5.4/ADTF-Display-Toolbox-3.5.0.tgz -P ADTF/addons/ && mkdir ADTF/addons/displaytoolbox && tar -xzf ADTF/addons/displaytoolbox*.tgz -C ADTF/addons/displaytoolbox/ --strip-components 1
